...
5. Group related supported fixes, preserve scope, and run focused verification while editing.
6. Run one relevant regression check on the combined result and report the evidence.
